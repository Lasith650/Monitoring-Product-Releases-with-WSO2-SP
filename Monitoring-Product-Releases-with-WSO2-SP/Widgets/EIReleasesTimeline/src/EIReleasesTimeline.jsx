...
import './EIReleasesTimeline.css';

const COOKIE = 'DASHBOARD_USER';

class EIReleasesTimeline extends Widget {
            ...
            <Scrollbars style={{height: this.state.height}}>
                <div className="timeline-wrapper">
                    <div
                        ...
                        <img src={eilogo} width="200" height="30"/>
...
global.dashboard.registerWidget('EIReleasesTimeline', EIReleasesTimeline);