...
import './APIMReleasesTimeline.css';

const COOKIE = 'DASHBOARD_USER';

class APIMReleasesTimeline extends Widget {
    ...
    populateTimeline(data) {
        ...
        var myDate = new Date();
        var newDate = new Date(myDate.getTime() - (60*60*24*20*1000));
            ...
            <Scrollbars style={{height: this.state.height}}>
                <div className="timeline-wrapper">
                    <div
                        ...
                        <img src={apimlogo} width="200" height="30" />
...
global.dashboard.registerWidget('APIMReleasesTimeline', APIMReleasesTimeline);